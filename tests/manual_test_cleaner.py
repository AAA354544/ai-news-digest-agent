...
def main() -> None:
    ...
    max_llm_candidates = cfg.max_llm_candidates
    ...
    cleaned_only = clean_candidates(raw_candidates, lookback_hours=lookback_hours)
    ...
    print(f"max llm candidates: {max_llm_candidates}")
